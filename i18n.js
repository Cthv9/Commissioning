(function () {
  ...
  const dict = {
    it: {
      ...
      'nuovo.tipo.primoAvviamento': 'Primo Avviamento',
      'nuovo.tipo.primoCommissioning': 'Primo Commissioning',
    ...
    en: {
      ...
      'nuovo.tipo.primoAvviamento': 'First Startup',
      'nuovo.tipo.primoCommissioning': 'First Commissioning',
      'nuovo.tipo.commissioning': 'Commissioning',
