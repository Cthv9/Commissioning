(function () {
  ...
  const dict = {
    it: {
      ...
      'wizard.intro': 'Scegli il reparto per cui userai il portale. La scelta imposta la terminologia e il file Excel usato e non potrà essere cambiata dall\'app in seguito.',
      'wizard.fields': 'Campi: {fields}',
      'wizard.confirm.text': 'Confermi il profilo «{profile}»? Per cambiarlo in seguito servirà l\'intervento dell\'IT.',
      'wizard.back': 'Indietro',
      'wizard.confirm': 'Conferma',
      'wizard.error': 'Impossibile salvare la scelta.',
      ...
      'manage.historicalNotice.title': 'Record da archivio storico',
      'manage.historicalNotice.body': 'Questo record è stato generato automaticamente da un archivio storico e non tramite il portale. I file relativi non si trovano in una cartella dedicata. Per trovarli usa la funzione Cerca di Windows nella cartella radice che si aprirà.',
      'manage.historicalNotice.openRoot': 'Apri cartella radice',
    ...
    en: {
      ...
      'wizard.intro': 'Choose the department you will use the portal for. This sets the terminology and the Excel file used, and cannot be changed from the app afterwards.',
      'wizard.fields': 'Fields: {fields}',
      'wizard.confirm.text': 'Confirm the «{profile}» profile? Changing it later will require IT.',
      'wizard.back': 'Back',
      'wizard.confirm': 'Confirm',
      'wizard.error': 'Could not save the choice.',
      ...
      'manage.historicalNotice.title': 'Historical archive record',
      'manage.historicalNotice.body': 'This record was automatically generated from a historical archive and was not created through the portal. Its files are not stored in a dedicated folder. To find them, use the Windows Search function in the root folder that will open.',
      'manage.historicalNotice.openRoot': 'Open root folder',
